...
#下载自启动脚本
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/xujianjie1213/SHIPTV/master/meilin-iptv/wan-start
#设置权限
...
#下载开机运行脚本
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/xujianjie1213/SHIPTV/master/meilin-iptv/dns.conf#设置权限
